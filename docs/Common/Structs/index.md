...
|stationLocation|Common.GPSData|false|HMI should not include `shifted` param providing SiSData with `stationLocation` param|Provides the 3-dimensional geographic station location.|
