...
|isTemplate|Boolean|false||Optional value to specify whether it's a template image.<br>**Note:** A template image can be (re)colored by the HMI as needed by using an image pattern.|
